...
namespace BattleBall.Core
{
    internal class Game
    {
        ...
        internal Game()
        {
            ...
            BaseItem hween12_track = ItemManager.AddRoomItem(baseItemId++, 4731, 1, 1, 0.15, "hween12_track", 3, true, true, false, new List<int>() { 0, 2, 4, 6 });
            BaseItem hween12_track_crl = ItemManager.AddRoomItem(baseItemId++, 4736, 1, 1, 0.15, "hween12_track_crl", 3, true, true, false, new List<int>() { 0, 2, 4, 6 });
            BaseItem hween12_track_crr = ItemManager.AddRoomItem(baseItemId++, 4739, 1, 1, 0.15, "hween12_track_crr", 3, true, true, false, new List<int>() { 0, 2, 4, 6 });
            ...
            Room.RoomItemManager.AddRoomItemToRoom(itemId++, 7, 0, z, stories_shakespeare_tree.Directions[0], 0, stories_shakespeare_tree);
            ...
            //Room.RoomItemManager.AddRoomItemToRoom(itemId++, 7, 11, z, hween12_track_crl.Directions[0], 0, hween12_track_crl);
